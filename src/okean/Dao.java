...
public final class Dao
{
    ...
    public static String isAuthenticated() throws Exception
    {
        ...
        try
        {
        		AuthenticationInfo response = connector().get(isAuthenticatedUrl, AuthenticationInfo.class, null, null);
            //Response response = connector().get(isAuthenticatedUrl, Response.class, null, null);
            if(response == null) {
            		return connector().buildUrl("/qcbin/api/authentication/sign-in");
            }
    ...
    public static void login(String username, String password) throws Exception
    {
        ...
        if (authenticationPoint != null)
        {
            ...
            KeywordLogger.getInstance().info(uri.getPath());
    ...
    {
        String logoutUrl = "/qcbin/api/authentication/sign-out";

        connector().get(logoutUrl, Response.class, connector().getAuthHeader(), null);
    }
    ...
    {
        String testUrl = connector().buildEntityUrl("tests", id);
    ...
    public static TestSet readTestSet(String id) throws Exception
    {
        ...
        return connector().get(testSetUrl, TestSet.class, connector().getAuthHeader(), null);
    }
    ...
    public static TestInstance readTestInstance(String id) throws Exception
    {
        ...
        return connector().get(testInstanceUrl, TestInstance.class, connector().getAuthHeader(), null);
    }
    ...
    public static TestInstances readTestInstances(String testSetId) throws Exception
    {
        ...
        return connector().get(testInstancesUrl, TestInstances.class, connector().getAuthHeader(), criteria);
    }
    ...
    public static Run createRun(Run run) throws Exception
    {
        ...
        return connector().post(runsUrl, Run.class, connector().getAuthHeader(), null, run);
    }
    ...
    public static Run updateRun(Run run) throws Exception
    {
        ...
        return connector().put(runUrl, Run.class, connector().getAuthHeader(), null, run);
    }
    ...
    public static RunSteps readRunSteps(String runId) throws Exception
    {
        ...
        return connector().get(runStepsUrl, RunSteps.class, connector().getAuthHeader(), null);
    }
    ...
    public static RunStep createRunStep(RunStep runStep) throws Exception
    {
        ...
        return connector().post(runStepsUrl, RunStep.class, connector().getAuthHeader(), null, runStep);
    }
    ...
    public static RunStep updateRunStep(RunStep runStep) throws Exception
    {
        ...
        return connector().put(runStepUrl, RunStep.class, connector().getAuthHeader(), null, runStep);
    }
    ...
    private static Attachment createAttachment(String entityUrl, String fileName, byte[] fileData) throws Exception
    {
        ...
        for(String key : connector().getAuthHeader().keySet()) {
	        headers.add(key, connector().getAuthHeader().get(key));
        }
