...
public class UntilLocatorReturnsNumberOfElements extends WaitKeyword {
	...
	public static WaitKeyword instantiateExternal(KeywordProvider keywordProvider, List<ObjectDef> defs,
			List<String> params) {
		return new UntilLocatorReturnsNumberOfElements(keywordProvider.driver, castToBy(defs.get(0)), (int)Double.parseDouble(params.get(0)), keywordProvider.loggers, (long)Double.parseDouble(params.get(1)));
	}
}
