...
public class UntilLocatorReturnsLessThan extends WaitKeyword {
	...
	public static WaitKeyword instantiateExternal(Framework framework, List<ObjectDef> defs,
			List<String> params) {
		return new UntilLocatorReturnsLessThan(framework.driver, castToBy(defs.get(0)), (int)Double.parseDouble(params.get(0)), framework.logger, (long)Double.parseDouble(params.get(1)));
	}
}
